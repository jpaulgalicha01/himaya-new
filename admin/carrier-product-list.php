...
<main>
	<div class="container-fluid px-4">
        <h1 class="mt-4">Carrier Products</h1>
        <br>
        <div class="card mb-4">
      ...
      <div class="modal-body">
        <form class="form-group" action="inputConfig.php" method="POST">
            ...
            <div class="py-2">
                ...
                <input type="text" id="capacity" class="form-control" disabled>
            </div>
            <div class="py-2">
                <label>Standardize:</label>
                <input type="text" id="Standardize" class="form-control" disabled>
            </div>
            <div class="py-2">
                <label>Status:</label>
...
<script>
    ...
    $("#type_product").change(function(){
      ...
      $.ajax({
        type:"POST",
        url: "fetchStatusCarrierProd.php",
        ...
        $.ajax({
            ...
            success:function(fetch){
                ...
                if(res.status == 200){
                    ...
                    $("#capacity").val(res.data.carrier_cap);
                    $("#Standardize").val(res.data.carrier_standardize);
